...
//            case R.id.btn_cam:
//                if (isCamOn) {
//                    btnCam.setImageResource(R.drawable.videocam_off_icon);
//                } else {
//                    btnCam.setImageResource(R.drawable.videocam_on_icon);
//                }
//                isCamOn = !isCamOn;
...
//                    btnVisibility.setImageResource(R.drawable.visibility_icon);
//                } else {
//                    vOtherCamera.setVisibility(View.GONE);
//                    btnVisibility.setImageResource(R.drawable.visibility_off_icon);
//                }
//                break;
//        }
//    }
...
//
//        //connect to room
//        mStringeeRoom = StringeeVideo.connect(Tab_1_Class_Test.client, roomToken, new StringeeRoomListener() {
//            @Override
...
//                    @Override
//                    public void run() {
//                        if (!stringeeVideoTrack.getUserId().equals(Tab_1_Class_Test.client.getUserId())) {
